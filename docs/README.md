...
| [UI_SYSTEM.md](UI_SYSTEM.md) | The design system: token vocabulary, the certainty axis, fifteen primitives, dark mode, the seven phases. Phases 0–2 and 4 built; **3 skipped**, 5–7 unstarted | Deep. Read the status line first — one phase is out of sequence and five counts in the body are superseded |
