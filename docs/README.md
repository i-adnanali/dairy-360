...
| [UI_SYSTEM.md](UI_SYSTEM.md) | The design system: token vocabulary, the certainty axis, fifteen primitives, dark mode, the seven phases. Phases 0–4 built (3 landed after 4); 5–7 unstarted | Deep. Read the status line first — one phase is out of sequence and five counts in the body are superseded |
