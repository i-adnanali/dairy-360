...
| [UI_SYSTEM.md](UI_SYSTEM.md) | The design system: token vocabulary, the certainty axis, fifteen primitives, dark mode, the seven phases. Phases 0–1 built, phase 2 blocked on the trial | Deep. Read the status line first — five counts in the body are superseded |
